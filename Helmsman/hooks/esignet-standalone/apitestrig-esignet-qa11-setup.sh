#!/bin/bash
# =============================================================================
# eSignet 1.7.1 - eSignet-QA11 API Testrig Pre-install Setup
# =============================================================================
# Prepares the esignet-qa11 namespace for the esignet-qa11-apitestrig release.
# keycloak-host and keycloak-client-secrets are already present in esignet-qa11
...
echo "================================================"
echo "eSignet 1.7.1 - eSignet-QA11 API Testrig Pre-install"
echo "================================================"
...
echo "eSignet-QA11 API Testrig pre-install setup completed."
