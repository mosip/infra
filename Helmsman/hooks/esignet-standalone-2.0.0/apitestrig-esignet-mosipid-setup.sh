...
# =============================================================================
# esignet-go-mosipid-apitestrig now deploys the dedicated mosip/esignet-apitestrig chart
...
# s3-esignet-go-mosipid-apitestrig/apitestrig-esignet-go-mosipid-apitestrig Secrets the OLD
...
kubectl -n "$NS" delete --ignore-not-found=true secret s3-esignet-go-mosipid-apitestrig apitestrig-esignet-go-mosipid-apitestrig
