# GCP Base Infrastructure Implementation
provider "google" {
...
variable "create_jumpserver_eip" {
  description = "Whether to create a static IP for the jumpserver"
  type        = bool
  default     = true
}
...
output "cloud_specific" {
  description = "Map of GCP-specific resource identifiers and configurations"
