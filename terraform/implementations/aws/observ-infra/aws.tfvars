...
# MOSIP domain
cluster_env_domain = "obs19.mosip.net"
...
rancher_hostname           = "rancher.obs19.mosip.net" # Will default to rancher.testvpc.mosip.net
...
keycloak_hostname = "iam.obs19.mosip.net" # Will default to iam.testvpc.mosip.net
