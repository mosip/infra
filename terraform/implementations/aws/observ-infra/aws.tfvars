...
# MOSIP domain
cluster_env_domain = "obs20.mosip.net"
...
rancher_hostname           = "rancher.obs20.mosip.net" # Will default to rancher.testvpc.mosip.net
...
keycloak_hostname = "iam.obs20.mosip.net" # Will default to iam.testvpc.mosip.net
