...
# MOSIP domain
cluster_env_domain = "obs16.mosip.net"
...
rancher_hostname           = "rancher.obs16.mosip.net" # Will default to rancher.testvpc.mosip.net
...
keycloak_hostname = "iam.obs16.mosip.net" # Will default to iam.testvpc.mosip.net
