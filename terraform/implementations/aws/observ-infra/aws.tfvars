...
# MOSIP domain
cluster_env_domain = "obs17.mosip.net"
...
rancher_hostname           = "rancher.obs17.mosip.net" # Will default to rancher.testvpc.mosip.net
...
keycloak_hostname = "iam.obs17.mosip.net" # Will default to iam.testvpc.mosip.net
