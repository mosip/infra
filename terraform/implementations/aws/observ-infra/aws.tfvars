...
# MOSIP domain
cluster_env_domain = "obs18.mosip.net"
...
rancher_hostname           = "rancher.obs18.mosip.net" # Will default to rancher.testvpc.mosip.net
...
keycloak_hostname = "iam.obs18.mosip.net" # Will default to iam.testvpc.mosip.net
