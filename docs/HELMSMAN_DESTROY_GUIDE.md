...
| ----------------------------------- | ------------------------------------------ | ----------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Destroy Testrigs**          | `helmsman_testrigs_destroy.yml`          | Removes test rig services     | `apitestrig`, `dslrig`, `uitestrig` (MOSIP platform); `esignet`, `esignet-mosipid`, `esignet-sunbird`, `signup` (esignet profile apitestrigs) |
...
| **Destroy eSignet Services**  | (use `helmsman_esignet.yml` with `--destroy`) | Removes eSignet stack (esignet profile) | `esignet`, `esignet-mosipid`, `esignet-sunbird`, `signup`, `kernel` |
